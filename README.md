...
- 修改基站功率
```
node ./ws.js 127.0.0.1:9001 '{"message":"cell_gain","cell_id":1,"gain":-30}'  #gain范围：-200~0
```
**远程修改将127.0.0.1替换为基站IP地址**，端口见基站配置文件：
<div align="center"><img src="https://github.com/dragonstrong/mi3m/blob/main/image1/1.png" width="400"></div>
...
# 2.全景相机推拉流
全景相机```（DHCP）```网线连```CPE```，创维头显也连```CPE```（只要网络连通在不在同一局域网都可，不在同一子网时拉流地址为CPE的WAN IP）</br>
...
## FTP
[参考](https://blog.csdn.net/dragonstrong/article/details/115771148?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522168243723716782425150611%2522%252C%2522scm%2522%253A%252220140713.130102334.pc%255Fblog.%2522%257D&request_id=168243723716782425150611&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~blog~first_rank_ecpm_v1~rank_v31_ecpm-1-115771148-null-null.blog_rank_default&utm_term=ftp&spm=1018.2226.3001.4450)
